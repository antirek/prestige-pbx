<?php
/*
 Copyright (C) 2006-2010 Earl C. Terwilliger
...
*/
 echo "<HTML>\n";
 echo " <HEAD>\n";
 echo "  <META NAME=\"Copyright\"     CONTENT=\"Copyright (C) 2006-2010 Earl Terwilliger earl@micpc.com All Rights reserved\">\n";
 echo "  <META NAME=\"Description\"   CONTENT=\"PHP script '";
 echo $_SERVER['PHP_SELF'];
 echo "' Copyright (C) 2006-2010 by Earl C. Terwilliger earl@micpc.com\">\n";
 echo "  <TITLE>Asterisk Event Monitor</TITLE>\n";
