...
$FG_TABLE_COL[]=array ("Calldate", "calldate", "18%", "left", "SORT", "19");
...
$FG_TABLE_COL[]=array ("Длительность", "billsec", "6%", "center", "SORT", "30", "", "", "", "", "", "$minute_function");

$FG_TABLE_COL[]=array ("Department", "userfield", "14%", "center", "", "20");
$FG_TABLE_COL[]=array ("Accountcode", "accountcode", "10%", "center", "", "20");
$FG_TABLE_COL[]=array ("PDD", "(duration-billsec)", "10%", "center", "", "20");
		...
		<table class="bar-status" width="75%" border="0" cellspacing="1" cellpadding="2" align="center">
			...
			<tr>
        		<td align="left" bgcolor="#000033">					
      			...
      			<td class="bar-search" align="left" bgcolor="#acbdee">
					...
					<b>Диапазон для сравнения :</b> 
				 	<select name="days_compare" class="intxt">
					<option value="4" <?php  if ($days_compare=="4"){ echo "selected";}?>>- 4 дня</option>
					<option value="3" <?php  if ($days_compare=="3"){ echo "selected";}?>>- 3 дня</option>
					<option value="2" <?php  if (($days_compare=="2")|| !isset($days_compare)){ echo "selected";}?>>- 2 дня</option>
					<option value="1" <?php  if ($days_compare=="1"){ echo "selected";}?>>- 1 день</option>
					</select>
					</td></tr></table>
	  			</td>
    		</tr>	
			...
			<tr>
				...
				<td class="bar-search" align="center" bgcolor="#acbdee">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#acbdee"><tr><td>				
						<b>График :</b>
							<select name="min_call" class="intxt">					
							<option value=1 <?php  if ($min_call==1){ echo "selected";}?>>Минут в час</option>
							<option value=0 <?php  if (($min_call==0) || !isset($min_call)){ echo "selected";}?>>Звонков в час</option>
							</select>
						</td>
						<td align="right">							
