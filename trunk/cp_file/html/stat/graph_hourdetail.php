...
if ($typegraph == 'fluctuation'){
		...
		$graph->tabtitle->Set("$fromstatsmonth_sday-$fromstatsday_sday Часовой График - От $hourinterval До $hourintervalplus - Звонков $nbcall - "."Макс. Нагр. = $maxload");
...
//		$graph->legend->SetFont(FF_FONT1,FS_BOLD); 
		...
		$graph->yaxis->SetLabelFormatString('%1d зв.'); 
...
//			    $p1[$i]->SetLegend("Makc. Нагр. = $maxload");
